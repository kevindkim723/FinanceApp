...
public class Frag1 extends Fragment {
    ...
    private void updateUI(String stockname, String value, String change, ArrayList<DataEntry> dataEntryArrayList) {
        TextView stock_name = getView().findViewById(R.id.stock_name);
        TextView stock_price = getView().findViewById(R.id.stock_price);
        TextView stock_change = getView().findViewById(R.id.stock_change);
        ...
        AnyChartView acv = getView().findViewById(R.id.any_chart_view);
        chart.xGrid(true);
        chart.yGrid(true);
...
/*for (int i = 0; i < e.size(); i++) {
                ...
                Toast.makeText(getActivity(), "NO STOCK FOUND WITH THAT NAME", Toast.LENGTH_LONG);
                e.printStackTrace();
            }
        }
